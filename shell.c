...
void imtheparent(pid_t child_pid, int run_in_background)
{
    ...
    if (child_error_code != 0)
    {
        ...
        fprintf(stderr,
                "  Parent says 'Child process %d failed with cod                                                                                                                                                                                                                                             e %d'\n",
...
int main(int argc, char **argv)
{
    ...
    while (1)
    {
        ...
        /* Parse the arguments: the first argument is the file or comman                                                                                                                                                                                                                                             d *
                 * we want to run.                                                                                                                                                                                                                                                                                             */
        if (*buffer == '!' && counter <= 9)
        {
            int i = atoi(buffer + 1);
        ...
        /* If no command was given (empty line) the Shell just prints th                                                                                                                                                                                                                                             e prompt again */
        if (!exec_argc)
        {
            continue;
        }
        ...
        else
        {
            ...
            if (pid_from_fork < 0)
            {
                /* Error: fork() failed.  Unlikely, but possible                                                                                                                                                                                                                                              (e.g. OS *
                                 * kernel runs out of memory or process descript                                                                                                                                                                                                                                             ors).     */
